...
export const matches = pgTable('match', {
  ...
  firstSetTieBreakOpponent: integer('firstSetTieBreakOpponent').default(0),
  ...
  secondSetTieBreakOpponent: integer('secondSetTieBreakOpponent').default(0),
  ...
  thirdSetTieBreakOpponent: integer('thirdSetTieBreakOpponent').default(0),
